...
class EpisodeResourceIT {
    ...
    public static Episode createEntity(EntityManager em) {
        Episode episode = new Episode().name(DEFAULT_NAME).duree(DEFAULT_DUREE);
        return episode;
    }
    ...
    public static Episode createUpdatedEntity(EntityManager em) {
        Episode episode = new Episode().name(UPDATED_NAME).duree(UPDATED_DUREE);
        return episode;
    }
    ...
    void putNewEpisode() throws Exception {
        ...
        updatedEpisode.name(UPDATED_NAME).duree(UPDATED_DUREE);
    ...
    void fullUpdateEpisodeWithPatch() throws Exception {
        ...
        partialUpdatedEpisode.name(UPDATED_NAME).duree(UPDATED_DUREE);

...
class SerieResourceIT {
    ...
    public static Serie createEntity(EntityManager em) {
        Serie serie = new Serie().name(DEFAULT_NAME).dateHeureAjout(DEFAULT_DATE_HEURE_AJOUT);
        return serie;
    }
    ...
    public static Serie createUpdatedEntity(EntityManager em) {
        Serie serie = new Serie().name(UPDATED_NAME).dateHeureAjout(UPDATED_DATE_HEURE_AJOUT);
        return serie;
    }
    ...
    void putNewSerie() throws Exception {
        ...
        updatedSerie.name(UPDATED_NAME).dateHeureAjout(UPDATED_DATE_HEURE_AJOUT);
    ...
    void fullUpdateSerieWithPatch() throws Exception {
        ...
        partialUpdatedSerie.name(UPDATED_NAME).dateHeureAjout(UPDATED_DATE_HEURE_AJOUT);
